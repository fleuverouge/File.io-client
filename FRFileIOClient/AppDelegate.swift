...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = ColorTemplate.MainTint
        UINavigationBar.appearance().tintColor = ColorTemplate.LightText
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName: ColorTemplate.LightText]
